...
function fileList( files, d){
    ...
    pagHTML += `
          ...
          <div class="w3-container w3-teal">
              <address>Generated by A84775::PRI2020 em ${d} --------------</address>
          </div>
      </body>
      </html>
    `
...
function fileForm( d ){
    ...
    <html>
        <head>
            ...
            <link rel="stylesheet" href="/w3.css"/>
            <script src="/jquery-3.5.1.min.js"></script>
            <script src="/multfiles.js"></script>
            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.js"></script>
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.css" />
        </head>
        <body>
            ...
            <form class="w3-container" action="/files" method="POST" enctype="multipart/form-data">
                ...
                <input class="w3-btn w3-green" type="submit" style="margin:10px" value="Submeter"/>
                <a href="/" class="w3-btn w3-red" type="button"> Cancelar </a>
                <input class="w3-btn w3-blue-grey" type="button" style="margin:10px" value="Adicionar" onclick="addInput();"/> 
                <input class="w3-btn w3-blue-grey" type="button" value="Remover" onclick="remInput();"/> 
            </form>
...
function geraPostConfirm( aluno, d){
    ...
    <body>
        <div class="w3-card-4">
            ...
            <footer class="w3-container w3-teal">
                <address>Gerado por A84775::PRI2020 em ${d} - [<a href="/">Voltar</a>]</address>
            </footer>
        </div>
    </body>
    </html>
